  ...
  return (
    ...
    >
      <button
        ...
        className={`flex items-center gap-1 px-3 py-2 rounded-md transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 ${
          ...
          {item.children.map((child, index) => (
            ...
            >
              {child.href ? (
                ...
                <button
                  onClick={() => handleItemClick(child)}
                  className={`w-full block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                    isMobile ? 'rounded-md' : 'first:rounded-t-md last:rounded-b-md'
                  }`}
                  role='menuitem'
                >
          ...
          {brand && (
            <div className='flex-shrink-0'>
              {brand.href ? (
                <a
                  href={brand.href}
                  className='text-xl font-bold text-gray-900 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md px-2 py-1'
            ...
            {items.map((item, index) => (
              ...
              >
                {item.children ? (
                  ...
                  <a
                    href={item.href}
                    className='px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500'
              ...
              {items.map((item, index) => (
                <div key={index}>
                  {item.children ? (
                    ...
                    <button
                      onClick={() => handleItemClick(item)}
                      className='w-full text-left block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500'
                    >
                      {item.label}
                    </button>
                  )}
